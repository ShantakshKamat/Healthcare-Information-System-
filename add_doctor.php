...
if(isset($_POST['add_doctor'])){
    ...
    $check="SELECT * FROM doctor WHERE dname='$dname' AND contact='$contact'";
    ...
    $sql="INSERT INTO doctor(dname,email,specialization,contact) VALUES('$dname','$email','$specialization','$contact')";
