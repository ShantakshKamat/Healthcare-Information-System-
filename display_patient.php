    ...
    <div>
        ...
        <table border="1px">
            ...
            <tr>
                ...
                <td class="table_th"> <?php echo "{$info['gender']}";?></td>
                <td class="table_th"> <?php echo "{$info['phone']}";?></td>
                <td class="table_th"> <?php echo "{$info['email']}";?></td>
                <td class="table_th"> 
                    <?php 
                        echo "<a onClick=\"javascript:return confirm('Are you sure to delete?');\"
                        class='btn btn-danger' href='delete.php?patient_id={$info['pid']}'>Delete</a>";
                    ?>
                </td>
                <td class="table_th"> 
                    <?php 
                        echo "<a onClick=\"javascript:return confirm('Are you sure to update?');\"
                        class='btn btn-primary'href='update_patient.php?patient_id={$info['pid']}'>Update</a>";
                    ?>
                </td>
            </tr>
            <?php
